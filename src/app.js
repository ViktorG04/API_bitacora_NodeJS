...
import incapacidadesRoutes from './routes/incapacidades.routes';
import reportesRouters from './routes/reportes.routers';
...
app.use(raiz, incapacidadesRoutes);
app.use(raiz, reportesRouters);
